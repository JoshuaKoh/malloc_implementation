...
ORDER tells general add and free helper functions whether to operate with a
size or address ordered free list.
*/
enum ORDER { SIZE, ADDRESS };

/* HELPER FUNCS
See my_malloc.c for documentation.
*/
